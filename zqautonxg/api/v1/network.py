...
# Pre-computed static response to avoid allocation on every request.
# Using tuples for collections ensures immutability and thread safety.
...
async def get_network_topology() -> dict[str, Any]:
    ...
    # Return pre-computed template to avoid allocation overhead
